<div>
    ...
    <form wire:submit.prevent="crearReconocimientos">
      ...
      >
        ...
        <span class="relative">Crear Reconocimiento</span>
    </button>
...
@push('scripts')
    ...
    <script>
        Livewire.on('creado', () => {
            Swal.fire({
                title: 'Reconocimiento creado exitosamente!',
                text: 'El reconocimiento se ha creado exitosamente.',
                icon: 'success',
            }).then(() => {
