    ...
    <div>
        ...
        <div class='block lg:flex gap-8 mt-9 items-center lg:justify-center'> {{-- PADRE --}}
            ...
            <select wire:model.live="tecnologiaSeleccionada"
                class="hidden lg:flex text-gray-400 lg:w-1/5 h-12 bg-gray-100 py-3 px-4 pe-9 block border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
